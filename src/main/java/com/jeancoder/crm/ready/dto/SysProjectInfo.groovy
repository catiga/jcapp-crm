...
public class SysProjectInfo {
	...
	private BigInteger dbpid;
	
	private BigInteger rbpid;
	...
	public BigInteger getDbpid() {
		return dbpid;
	}

	public void setDbpid(BigInteger dbpid) {
		this.dbpid = dbpid;
	}

	public BigInteger getRbpid() {
		return rbpid;
	}

	public void setRbpid(BigInteger rbpid) {
		this.rbpid = rbpid;
	}
