...
class OrderMcService {
	...
	public OrderMc admin_create_order(String mc_num, MemberCardHierarchy mch, BigInteger pid,BigInteger sid, 
		String sname,BigInteger pre_id, String mc_name,String mc_mobile,String id_card,String init_pwd, def tolen) {
	...
	public OrderMc get_crm_card_item(String order_no) {
		String sql = "select * from OrderMc where order_no=? and flag!= -1";
		return jcTemplate.get(OrderMc.class, sql,order_no);
	}
